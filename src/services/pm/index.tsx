 ...
 * Get the list of all evaluations
 */
export const useGetEvaluationList = (props: UseGetEvaluationListProps) => useGet<EvaluationListResponse, unknown, void, void>(`/evaluations`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Delete the evaluation by ID
 */
export const useDeleteEvaluation = (props: UseDeleteEvaluationProps) => useMutate<void, unknown, void, string, void>("DELETE", `/evaluations`, { base:getConfig("pm/api/v1"),  ...props });
...
export type GetEvaluationProps = Omit<GetProps<EvaluationResponse, unknown, void, GetEvaluationPathParams>, "path"> & GetEvaluationPathParams;
...
export type UseGetEvaluationProps = Omit<UseGetProps<EvaluationResponse, unknown, void, GetEvaluationPathParams>, "path"> & GetEvaluationPathParams;

/**
 * Get the evaluation by ID
 */
export const useGetEvaluation = ({evaluation, ...props}: UseGetEvaluationProps) => useGet<EvaluationResponse, unknown, void, GetEvaluationPathParams>((paramsInPath: GetEvaluationPathParams) => `/evaluations/${paramsInPath.evaluation}`, { base:getConfig("pm/api/v1"), pathParams: { evaluation }, ...props });
 ...
 * Return system health information
 */
export const useLogin = (props: UseLoginProps) => useMutate<AuthResponse, unknown, void, LoginRequestBody, void>("POST", `/login`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Get the list of all policies
 */
export const useGetPolicyList = (props: UseGetPolicyListProps) => useGet<PolicyListResponse, unknown, void, void>(`/policies`, { base:getConfig("pm/api/v1"),  ...props });


export type CreatePolicyProps = Omit<MutateProps<PolicyResponse, unknown, void, PolicyInputRequestBody, void>, "path" | "verb">;
...
export type UseCreatePolicyProps = Omit<UseMutateProps<PolicyResponse, unknown, void, PolicyInputRequestBody, void>, "path" | "verb">;

/**
 * Create a new policy
 */
export const useCreatePolicy = (props: UseCreatePolicyProps) => useMutate<PolicyResponse, unknown, void, PolicyInputRequestBody, void>("POST", `/policies`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Delete the policy by ID
 */
export const useDeletePolicy = (props: UseDeletePolicyProps) => useMutate<void, unknown, void, string, void>("DELETE", `/policies`, { base:getConfig("pm/api/v1"),  ...props });
...
export type GetPolicyProps = Omit<GetProps<PolicyResponse, unknown, void, GetPolicyPathParams>, "path"> & GetPolicyPathParams;
...
export type UseGetPolicyProps = Omit<UseGetProps<PolicyResponse, unknown, void, GetPolicyPathParams>, "path"> & GetPolicyPathParams;

/**
 * Get the policy by ID
 */
export const useGetPolicy = ({policy, ...props}: UseGetPolicyProps) => useGet<PolicyResponse, unknown, void, GetPolicyPathParams>((paramsInPath: GetPolicyPathParams) => `/policies/${paramsInPath.policy}`, { base:getConfig("pm/api/v1"), pathParams: { policy }, ...props });
...
export type UpdatePolicyProps = Omit<MutateProps<PolicyResponse, unknown, void, PolicyInputRequestBody, UpdatePolicyPathParams>, "path" | "verb"> & UpdatePolicyPathParams;
...
export type UseUpdatePolicyProps = Omit<UseMutateProps<PolicyResponse, unknown, void, PolicyInputRequestBody, UpdatePolicyPathParams>, "path" | "verb"> & UpdatePolicyPathParams;

/**
 * Update the policy by ID
 */
export const useUpdatePolicy = ({policy, ...props}: UseUpdatePolicyProps) => useMutate<PolicyResponse, unknown, void, PolicyInputRequestBody, UpdatePolicyPathParams>("PATCH", (paramsInPath: UpdatePolicyPathParams) => `/policies/${paramsInPath.policy}`, { base:getConfig("pm/api/v1"), pathParams: { policy }, ...props });
...
export type GetPolicySetListProps = Omit<GetProps<PolicysetListResponse, unknown, GetPolicySetListQueryParams, void>, "path">;
...
export type UseGetPolicySetListProps = Omit<UseGetProps<PolicysetListResponse, unknown, GetPolicySetListQueryParams, void>, "path">;

/**
 * Get the list of all policysets
 */
export const useGetPolicySetList = (props: UseGetPolicySetListProps) => useGet<PolicysetListResponse, unknown, GetPolicySetListQueryParams, void>(`/policysets`, { base:getConfig("pm/api/v1"),  ...props });


export type CreatePolicySetProps = Omit<MutateProps<PolicysetResponse, unknown, void, PolicySetInputRequestBody, void>, "path" | "verb">;
...
export type UseCreatePolicySetProps = Omit<UseMutateProps<PolicysetResponse, unknown, void, PolicySetInputRequestBody, void>, "path" | "verb">;

/**
 * Create a new policyset
 */
export const useCreatePolicySet = (props: UseCreatePolicySetProps) => useMutate<PolicysetResponse, unknown, void, PolicySetInputRequestBody, void>("POST", `/policysets`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Delete the policyset by ID
 */
export const useDeletePolicySet = (props: UseDeletePolicySetProps) => useMutate<void, unknown, void, string, void>("DELETE", `/policysets`, { base:getConfig("pm/api/v1"),  ...props });
...
export type GetPolicySetProps = Omit<GetProps<PolicysetResponse, unknown, void, GetPolicySetPathParams>, "path"> & GetPolicySetPathParams;
...
export type UseGetPolicySetProps = Omit<UseGetProps<PolicysetResponse, unknown, void, GetPolicySetPathParams>, "path"> & GetPolicySetPathParams;

/**
 * Get the policyset by ID
 */
export const useGetPolicySet = ({policyset, ...props}: UseGetPolicySetProps) => useGet<PolicysetResponse, unknown, void, GetPolicySetPathParams>((paramsInPath: GetPolicySetPathParams) => `/policysets/${paramsInPath.policyset}`, { base:getConfig("pm/api/v1"), pathParams: { policyset }, ...props });
...
export type UpdatePolicySetProps = Omit<MutateProps<PolicysetResponse, unknown, void, PolicySetInputRequestBody, UpdatePolicySetPathParams>, "path" | "verb"> & UpdatePolicySetPathParams;
...
export type UseUpdatePolicySetProps = Omit<UseMutateProps<PolicysetResponse, unknown, void, PolicySetInputRequestBody, UpdatePolicySetPathParams>, "path" | "verb"> & UpdatePolicySetPathParams;

/**
 * Update the policyset by ID
 */
export const useUpdatePolicySet = ({policyset, ...props}: UseUpdatePolicySetProps) => useMutate<PolicysetResponse, unknown, void, PolicySetInputRequestBody, UpdatePolicySetPathParams>("PATCH", (paramsInPath: UpdatePolicySetPathParams) => `/policysets/${paramsInPath.policyset}`, { base:getConfig("pm/api/v1"), pathParams: { policyset }, ...props });
...
export type DeleteLinkedPolicyProps = Omit<MutateProps<void, unknown, void, string, DeleteLinkedPolicyPathParams>, "path" | "verb"> & DeleteLinkedPolicyPathParams;
...
export type UseDeleteLinkedPolicyProps = Omit<UseMutateProps<void, unknown, void, string, DeleteLinkedPolicyPathParams>, "path" | "verb"> & DeleteLinkedPolicyPathParams;

/**
 * Delete the linked policy by ID
 */
export const useDeleteLinkedPolicy = ({policyset, ...props}: UseDeleteLinkedPolicyProps) => useMutate<void, unknown, void, string, DeleteLinkedPolicyPathParams>("DELETE", (paramsInPath: DeleteLinkedPolicyPathParams) => `/policysets/${paramsInPath.policyset}/policy`, { base:getConfig("pm/api/v1"), pathParams: { policyset }, ...props });
...
export type AddLinkedPolicyProps = Omit<MutateProps<void, unknown, void, LinkedPolicyInput, AddLinkedPolicyPathParams>, "path" | "verb"> & AddLinkedPolicyPathParams;
...
export type UseAddLinkedPolicyProps = Omit<UseMutateProps<void, unknown, void, LinkedPolicyInput, AddLinkedPolicyPathParams>, "path" | "verb"> & AddLinkedPolicyPathParams;

/**
 * Add a new linked policy
 */
export const useAddLinkedPolicy = ({policyset, policy, ...props}: UseAddLinkedPolicyProps) => useMutate<void, unknown, void, LinkedPolicyInput, AddLinkedPolicyPathParams>("PATCH", (paramsInPath: AddLinkedPolicyPathParams) => `/policysets/${paramsInPath.policyset}/policy/${paramsInPath.policy}`, { base:getConfig("pm/api/v1"), pathParams: { policyset, policy }, ...props });
...
export type UseRegisterProps = Omit<UseMutateProps<AuthResponse, unknown, void, LoginRequestBody, void>, "path" | "verb">;

/**
 * Return system version information
 */
export const useRegister = (props: UseRegisterProps) => useMutate<AuthResponse, unknown, void, LoginRequestBody, void>("POST", `/register`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Return system health information
 */
export const useHealth = (props: UseHealthProps) => useGet<void, unknown, void, void>(`/system/health`, { base:getConfig("pm/api/v1"),  ...props });
...
export const Version = (props: VersionProps) => (
  <Get<VersionResponse, unknown, void, void>
    path={`/system/version`}
    base={getConfig("pm/api/v1")}
 ...
 * Return system version information
 */
export const useVersion = (props: UseVersionProps) => useGet<VersionResponse, unknown, void, void>(`/system/version`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Get the authenticated user.
 */
export const useGetCurrentUser = (props: UseGetCurrentUserProps) => useGet<UserResponse, unknown, void, void>(`/user`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Get the list of all registered users.
 */
export const useGetUserList = (props: UseGetUserListProps) => useGet<UserListResponse, unknown, void, void>(`/users`, { base:getConfig("pm/api/v1"),  ...props });


export type CreateUserProps = Omit<MutateProps<UserResponse, unknown, void, UserInputRequestBody, void>, "path" | "verb">;
...
export type UseCreateUserProps = Omit<UseMutateProps<UserResponse, unknown, void, UserInputRequestBody, void>, "path" | "verb">;

/**
 * Create a new user.
 */
export const useCreateUser = (props: UseCreateUserProps) => useMutate<UserResponse, unknown, void, UserInputRequestBody, void>("POST", `/users`, { base:getConfig("pm/api/v1"),  ...props });
 ...
 * Delete the user with the matching email address.
 */
export const useDeleteUser = (props: UseDeleteUserProps) => useMutate<void, unknown, void, string, void>("DELETE", `/users`, { base:getConfig("pm/api/v1"),  ...props });
...
export type UseGetUserProps = Omit<UseGetProps<UserResponse, unknown, void, GetUserPathParams>, "path"> & GetUserPathParams;

/**
 * Get the user with the matching email address.
 */
export const useGetUser = ({user, ...props}: UseGetUserProps) => useGet<UserResponse, unknown, void, GetUserPathParams>((paramsInPath: GetUserPathParams) => `/users/${paramsInPath.user}`, { base:getConfig("pm/api/v1"), pathParams: { user }, ...props });
...
export type UpdateUserProps = Omit<MutateProps<UserResponse, unknown, void, UserInputRequestBody, UpdateUserPathParams>, "path" | "verb"> & UpdateUserPathParams;
...
export type UseUpdateUserProps = Omit<UseMutateProps<UserResponse, unknown, void, UserInputRequestBody, UpdateUserPathParams>, "path" | "verb"> & UpdateUserPathParams;

/**
 * Update the user with the matching email address.
 */
export const useUpdateUser = ({user, ...props}: UseUpdateUserProps) => useMutate<UserResponse, unknown, void, UserInputRequestBody, UpdateUserPathParams>("PATCH", (paramsInPath: UpdateUserPathParams) => `/users/${paramsInPath.user}`, { base:getConfig("pm/api/v1"), pathParams: { user }, ...props });
